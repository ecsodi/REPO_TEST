...
class Window(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		self.ItemSlot.SetPosition(130, 210)
		self.ItemSlot.ArrangeSlot(0, 1, 1, 32, 32, 0, 0)
		self.ItemSlot.SetOverInItemEvent(ui.__mem_func__(self.OverInItemSlotSpecial))
		self.ItemSlot.SetOverOutItemEvent(ui.__mem_func__(self.OnOverOutItem))
		self.ItemSlot.SetItemSlot(0, 72341, 1)
		self.ItemSlot.Show()
	...
	def OverInItemSlotSpecial(self, slotIndex):
		if self.tooltipItem:
			self.tooltipItem.SetItemToolTip(72341)
