...
def SetGeneralMotions(mode, folder):
	...
	chrmgr.Character(NewPoints, mode,		chr.MOTION_WAIT,				"wait.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_WALK,				"walk.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_RUN,					"run.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE,				"damage.msa", 50)
	chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE,				"damage_1.msa", 50)
	chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE_BACK,			"damage_2.msa", 50)
	chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE_BACK,			"damage_3.msa", 50)
	chrmgr.Character(NewPoints, mode,		chr.MOTION_SUGI_PULA_DACA_VEZI,	"damage_flying.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_STAND_UP,			"falling_stand.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_NU_MAI_AI_VOIE_CSF,	"back_damage_flying.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_STAND_UP_BACK,		"back_falling_stand.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_DEAD,				"dead.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_DIG,					"dig.msa")
...
if app.ENABLE_WOLFMAN_CHARACTER:
	def SetNewGeneralMotions(mode, folder):
		...
		chrmgr.Character(NewPoints, mode,		chr.MOTION_WALK,				"walk.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_RUN,					"run.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE,				"front_damage.msa", 50)
		chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE,				"front_damage1.msa", 50)
		chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE_BACK,			"back_damage.msa", 50)
		chrmgr.Character(NewPoints, mode,		chr.MOTION_DAMAGE_BACK,			"back_damage1.msa", 50)
		chrmgr.Character(NewPoints, mode,		chr.MOTION_SUGI_PULA_DACA_VEZI,		"front_damage_flying.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_STAND_UP,			"front_falling_standup.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_NU_MAI_AI_VOIE_CSF,	"back_damage_flying.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_STAND_UP_BACK,		"back_falling_standup.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_DEAD,				"dead.msa")
		chrmgr.Character(NewPoints, mode,		chr.MOTION_DIG,					"dig.msa")
...
def SetIntroMotions(mode, folder):
	chrmgr.SetPathName(folder)
	chrmgr.RegisterMotionMode(mode)
	chrmgr.Character(NewPoints, mode,		chr.MOTION_INTRO_WAIT,			"wait.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_INTRO_SELECTED,		"selected.msa")
	chrmgr.Character(NewPoints, mode,		chr.MOTION_INTRO_NOT_SELECTED,	"not_selected.msa")
...
def __InitData():
	...
	if app.ENABLE_OFFLINE_SHOP:
		chrmgr.RegisterCacheEffect(chrmgr.EFFECT_MY_OFFLINE_SHOP, "", "d:/ymir work/effect/etc/direction/my_shop.mse") #put your own effect if you have

	if app.ENABLE_WOLFMAN_CHARACTER:
		chrmgr.CreateRace(RACE_WOLFMAN_M)
		chrmgr.SelectRace(RACE_WOLFMAN_M)
		chrmgr.LoadLocalRaceData("costume_si_armuri/armuri_/wolfman_m_armuri.msm")
		chrmgr.LoadLocalRaceData("costume_si_armuri/costume_/wolfman_m_costume.msm")
		SetIntroMotions(chr.NEW_678TH_SKILL_ENABLE, "d:/ymir work/pc3/wolfman/intro/")
...
def __LoadGameEffect():
	...
	# NEW_SMTH GRIMM
	chrmgr.RegisterEffect(chrmgr.EFFECT_AFFECT+45, "", "d:/ymir work/pc/shaman/effect/3hosin_loop_new2.mse")
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+3, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9.mse")#232
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+6, "PART_WEAPON_LEFT", "D:/ymir work/pc/common/effect/sword/sword_9_b.mse")#235
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+9, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_f.mse")#238
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+12, "PART_WEAPON", "D:/ymir work/pc/common/effect/sword/sword_9_s.mse")#241
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+17, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_8.mse")#246
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+18, "Bip01", "D:/ymir work/pc/common/effect/armor/armor_9.mse")#247

	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+19, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-1.mse")#248
	chrmgr.RegisterEffect(chrmgr.EFFECT_REFINED+20, "Bip01", "D:/ymir work/pc/common/effect/armor/armor-4-2-2.mse")#249
	...
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+12, "", EmoticonStr+"smartpepe.mse")
	net.RegisterEmoticonString("(¿ï¾Æ)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+13, "", EmoticonStr+"inlovepepe.mse")
	net.RegisterEmoticonString("(¾Æ»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+14, "", EmoticonStr+"devilpepe.mse")
	net.RegisterEmoticonString("(È²´çÈ²´ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+15, "", EmoticonStr+"fatpepe.mse")
	net.RegisterEmoticonString("(È²´ç»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+16, "", EmoticonStr+"painpepe.mse")
	net.RegisterEmoticonString("(È²¼Û»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+17, "", EmoticonStr+"giftheartpepe.mse")
	net.RegisterEmoticonString("(È²¼Û»çÈ²¼Û»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+18, "", EmoticonStr+"bearhugpepe.mse")
	net.RegisterEmoticonString("(ÁË¼ÛÁË¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+19, "", EmoticonStr+"depressedpepe.mse")
	net.RegisterEmoticonString("(±â±â»Ý»Ý)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+20, "", EmoticonStr+"simppepe.mse")
	net.RegisterEmoticonString("(¿ï¾Æ¿ï¾Æ)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+21, "", EmoticonStr+"hypepepe.mse")
	net.RegisterEmoticonString("(¾Æ¾Æ»ç»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+22, "", EmoticonStr+"hearteyespepe.mse")
	net.RegisterEmoticonString("(µ·»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+23, "", EmoticonStr+"happypepe.mse")
	net.RegisterEmoticonString("(¾ÆÁÁ)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+24, "", EmoticonStr+"grinpepe.mse")
	net.RegisterEmoticonString("(¶û¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+25, "", EmoticonStr+"ewpepe.mse")
	net.RegisterEmoticonString("(¶û¶û¼Û¼Û¶û¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+26, "", EmoticonStr+"eyerollpepe.mse")
	net.RegisterEmoticonString("(¶û¶û¼Û¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+27, "", EmoticonStr+"cryingpepe.mse")
	net.RegisterEmoticonString("(¿ï¿ï¾Æ¿ï¾Æ¾Æ¿ï¾Æ)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+28, "", EmoticonStr+"cringepepe.mse")
	net.RegisterEmoticonString("(È²È²´ç»ç´ç»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+29, "", EmoticonStr+"coolpepe.mse")
	net.RegisterEmoticonString("(¿ì¿ì¿ï¿ï)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+30, "", EmoticonStr+"blushpepe.mse")
	net.RegisterEmoticonString("(¾Æ¶û¼Û»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+31, "", EmoticonStr+"angelpepe.mse")
	net.RegisterEmoticonString("(ÁÁÁÁ¾Æ¾Æ)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+32, "", EmoticonStr+"hehepepe.mse")
	net.RegisterEmoticonString("(»çÁÁ»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+33, "", EmoticonStr+"kisspepe.mse")
	net.RegisterEmoticonString("(¶û»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+34, "", EmoticonStr+"nerdpepe.mse")
	net.RegisterEmoticonString("(È²È²´ç´ç»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+35, "", EmoticonStr+"monkapepe.mse")
	net.RegisterEmoticonString("(È²È²ÁÁ»ç´ç»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+36, "", EmoticonStr+"okaypepe.mse")
	net.RegisterEmoticonString("(ÁËÁË»ç¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+37, "", EmoticonStr+"heartstruckpepe.mse")
	net.RegisterEmoticonString("(¼Û¶û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+38, "", EmoticonStr+"tonguepepe.mse")
	net.RegisterEmoticonString("(¼Û¶û»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+39, "", EmoticonStr+"ughpepe.mse")
	net.RegisterEmoticonString("(¶û¾Æ)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+40, "", EmoticonStr+"uwupepe.mse")
	net.RegisterEmoticonString("(»ç¾Æ)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+41, "", EmoticonStr+"thinkingpepe.mse")
	net.RegisterEmoticonString("(»çµ·»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+42, "", EmoticonStr+"smilepepe.mse")
	net.RegisterEmoticonString("(¾Æ¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+43, "", EmoticonStr+"surrenderpepe.mse")
	net.RegisterEmoticonString("(¾Æ¿ïµ·)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+44, "", EmoticonStr+"whatifpepe.mse")
	net.RegisterEmoticonString("(ÁË¼Û¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+45, "", EmoticonStr+"sadpepe.mse")
	net.RegisterEmoticonString("(ÁËÁË¼Û¼Û)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+46, "", EmoticonStr+"peekpepe.mse")
	net.RegisterEmoticonString("(´ç´ç»ç»ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+47, "", EmoticonStr+"angrypepe.mse")
	net.RegisterEmoticonString("(¼Û´ç¼Û)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+48, "", EmoticonStr+"ley.mse")
	net.RegisterEmoticonString("(¼Û´ç»ç)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+49, "", EmoticonStr+"dollar.mse")
	net.RegisterEmoticonString("(»ç¾Æ´ç)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+50, "", EmoticonStr+"begone.mse")
	net.RegisterEmoticonString("(¾Æµ·)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+51, "", EmoticonStr+"pepelaughanim.mse")
	net.RegisterEmoticonString("(µ·ÁËµ·)")

	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+52, "", EmoticonStr+"blushpepeanim.mse")
	net.RegisterEmoticonString("(ÁË´ç»çÁË)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+53, "", EmoticonStr+"suspiciouspepe.mse")
	net.RegisterEmoticonString("(µ·»çµ·)")
		
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+54, "", EmoticonStr+"haha.mse")
	net.RegisterEmoticonString("(µ·¾Æ¾Æ)")
	
	chrmgr.RegisterEffect(chrmgr.EFFECT_EMOTICON+55, "", EmoticonStr+"catawkward.mse")
	net.RegisterEmoticonString("(¾Æ´ç¾Æ´ç)")
...
def __LoadGameWarriorEx(race, path):
	...
	## GENERAL MODE
	SetGeneralMotions(chr.NEW_678TH_SKILL_ENABLE, path + "general/")
	chrmgr.SetMotionRandomWeight(chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT, 0, 70)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT, "wait_1.msa", 30)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_COMBO_ATTACK_1, "attack.msa", 50)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_COMBO_ATTACK_1, "attack_1.msa", 50)
	...
	for i in xrange(skill.SKILL_EFFECT_COUNT):
		...
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+1, "samyeon" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+2, "palbang" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+3, "jeongwi" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+4, "geomgyeong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+5, "tanhwan" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+16, "gigongcham" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+17, "gyeoksan" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+18, "daejin" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+19, "cheongeun" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+20, "geompung" + END_STRING + ".msa")

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, GUILD_SKILL_DRAGONBLOOD, "guild_yongsinuipi.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, GUILD_SKILL_DRAGONBLESS, "guild_yongsinuichukbok.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, GUILD_SKILL_BLESSARMOR, "guild_seonghwigap.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, GUILD_SKILL_SPPEDUP, "guild_gasokhwa.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, GUILD_SKILL_DRAGONWRATH, "guild_yongsinuibunno.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, GUILD_SKILL_MAGICUP, "guild_jumunsul.msa")

	chrmgr.ReserveComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, 1)
	chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_1, chr.MOTION_COMBO_ATTACK_1)
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WAIT,				"wait.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WAIT,				"wait_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WALK,				"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,			"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,			"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE_BACK,		"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE_BACK,		"damage_3.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_1,	"combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_2,	"combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_3,	"combo_03.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_4,	"combo_04.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_5,	"combo_05.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_6,	"combo_06.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_7,	"combo_07.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_WAIT,				"wait.msa", 70)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_WAIT,				"wait_1.msa", 30)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_WALK,				"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_DAMAGE,			"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_DAMAGE,			"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_DAMAGE_BACK,		"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_DAMAGE_BACK,		"damage_3.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_1,	"combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_2,	"combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_3,	"combo_03.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_4,	"combo_04.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_5,	"combo_05.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_6,	"combo_06.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_7,	"combo_07.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_WAIT,			"wait.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_WALK,			"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_FISHING_THROW,	"throw.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_FISHING_WAIT,	"fishing_wait.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_FISHING_STOP,	"fishing_cancel.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_FISHING_REACT,	"fishing_react.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_FISHING_CATCH,	"fishing_catch.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FISHING, chr.MOTION_FISHING_FAIL,	"fishing_fail.msa")

	## HORSE
	chrmgr.SetPathName(path + "horse/")
	chrmgr.RegisterMotionMode(chr.MOTION_MODE_HORSE)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WAIT,				"wait.msa", 90)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WAIT,				"wait_1.msa", 9)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WAIT,				"wait_2.msa", 1)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WALK,				"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DAMAGE,			"damage.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DAMAGE_BACK,		"damage.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DEAD,				"dead.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, HORSE_SKILL_CHARGE,			"skill_charge.msa")

	## HORSE_ONEHAND_SWORD
	chrmgr.SetPathName(path + "horse_onehand_sword/")
	chrmgr.RegisterMotionMode(chr.MOTION_MODE_HORSE_ONEHAND_SWORD)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_ONEHAND_SWORD, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_ONEHAND_SWORD, HORSE_SKILL_WILDATTACK, "skill_wildattack.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_ONEHAND_SWORD, HORSE_SKILL_SPLASH, "skill_splash.msa")

	## HORSE_TWOHAND_SWORD
	chrmgr.SetPathName(path + "horse_twohand_sword/")
	chrmgr.RegisterMotionMode(chr.MOTION_MODE_HORSE_TWOHAND_SWORD)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_TWOHAND_SWORD, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_TWOHAND_SWORD, HORSE_SKILL_WILDATTACK, "skill_wildattack.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_TWOHAND_SWORD, HORSE_SKILL_SPLASH, "skill_splash.msa")
...
def __LoadGameAssassinEx(race, path):
	...
	for i in xrange(skill.SKILL_EFFECT_COUNT):
		END_STRING = ""
		if i != 0: END_STRING = "_%d" % (i+1)
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+1, "amseup" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+2, "gungsin" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+3, "charyun" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+4, "eunhyeong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+5, "sangong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+16, "yeonsa" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+17, "gwangyeok" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+18, "hwajo" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+19, "gyeonggong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+20, "dokgigung" + END_STRING + ".msa")
	...
	chrmgr.SetPathName(path + "onehand_sword/")
	chrmgr.RegisterMotionMode(chr.MOTION_MODE_ONEHAND_SWORD)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WAIT,		"wait.msa", 70)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WAIT,		"wait_1.msa", 30)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WALK,		"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_RUN,		"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,		"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,		"damage_1.msa", 50)
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_WAIT,			"wait.msa", 70)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_WAIT,			"wait_1.msa", 30)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_WALK,			"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_RUN,			"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_DAMAGE,		"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_DAMAGE,		"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_DAMAGE_BACK,	"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_DAMAGE_BACK,	"damage_3.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_4, "combo_04.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_5, "combo_05.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_6, "combo_06.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_7, "combo_07.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_8, "combo_08.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_WAIT,			"wait.msa", 70)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_WAIT,			"wait_1.msa", 30)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_WALK,			"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_RUN,			"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_DAMAGE,		"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_DAMAGE,		"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_DAMAGE_BACK,	"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_DAMAGE_BACK,	"damage_3.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BOW, chr.MOTION_COMBO_ATTACK_1,		"attack.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_DUALHAND_SWORD, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_DUALHAND_SWORD, HORSE_SKILL_WILDATTACK, "skill_wildattack.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_DUALHAND_SWORD, HORSE_SKILL_SPLASH, "skill_splash.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_WAIT,				"wait.msa", 90)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_WAIT,				"wait_1.msa", 9)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_WAIT,				"wait_2.msa", 1)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_DAMAGE,			"damage.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_DEAD,				"dead.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, chr.MOTION_COMBO_ATTACK_1,	"attack.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, HORSE_SKILL_WILDATTACK,		"skill_wildattack.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BOW, HORSE_SKILL_SPLASH,			"skill_splash.msa")
...
def __LoadGameSuraEx(race, path):
	...
	## SKILL
	chrmgr.SetPathName(path + "skill/")
	# chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+4, "geongon.msa")

	for i in xrange(skill.SKILL_EFFECT_COUNT):
		END_STRING = ""
		if i != 0: END_STRING = "_%d" % (i+1)
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+1, "swaeryeong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+2, "yonggwon" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+3, "gwigeom" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+4, "gongpo" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+5, "jumagap" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+6, "pabeop" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+16, "maryeong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+17, "hwayeom" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+18, "muyeong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+19, "heuksin" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+20, "tusok" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+21, "mahwan" + END_STRING + ".msa")
	...
	chrmgr.SetPathName(path + "onehand_sword/")
	chrmgr.RegisterMotionMode(chr.MOTION_MODE_ONEHAND_SWORD)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WAIT,				"wait.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_WALK,				"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,			"damage.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,			"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE,			"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE_BACK,		"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_ONEHAND_SWORD, chr.MOTION_DAMAGE_BACK,		"damage_3.msa", 50)
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DEAD,				"dead.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, HORSE_SKILL_CHARGE,			"skill_charge.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, HORSE_SKILL_SPLASH,			"skill_splash.msa")
...
def __LoadGameShamanEx(race, path):
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_WAIT,			"wait.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_WALK,			"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_RUN,				"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_DAMAGE,			"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_DAMAGE,			"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_DAMAGE_BACK,		"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_DAMAGE_BACK,		"damage_3.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_1,	"combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_2,	"combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_3,	"combo_03.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_4,	"combo_04.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_5,	"combo_05.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_6,	"combo_06.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_FAN, chr.MOTION_COMBO_ATTACK_7,	"combo_07.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_WAIT,			"wait.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_WALK,			"walk.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_RUN,			"run.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_DAMAGE,			"damage.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_DAMAGE,			"damage_1.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_DAMAGE_BACK,	"damage_2.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_DAMAGE_BACK,	"damage_3.msa", 50)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_1,	"combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_2,	"combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_3,	"combo_03.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_4,	"combo_04.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_5,	"combo_05.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_6,	"combo_06.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_BELL, chr.MOTION_COMBO_ATTACK_7,	"combo_07.msa")
	...
	## SKILL
	chrmgr.SetPathName(path + "skill/")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+1,		"bipabu.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+2,		"yongpa.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+3,		"paeryong.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+4,		"hosin_target.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+5,	"boho_target.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+6,	"gicheon_target.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+16,	"noejeon.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+17,	"byeorak.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+18,		"pokroe.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+19,		"jeongeop_target.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+20,		"kwaesok_target.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+21,	"jeungryeok_target.msa")
	#chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+10,	"budong.msa")
	...
	for i in SHAMY_LIST:
		END_STRING = ""
		if i != 0: END_STRING = "_%d" % (i+1)
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+1,	"bipabu" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+2,	"yongpa" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+3,	"paeryong" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+4,	"hosin" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+5,	"boho" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+6,	"gicheon" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+16,	"noejeon" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+17,	"byeorak" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+18,	"pokroe" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+19,	"jeongeop" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+20,	"kwaesok" + END_STRING + ".msa")
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+21,	"jeungryeok" + END_STRING + ".msa")
		#chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+10,	"budong" + END_STRING + ".msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_FAN, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_FAN, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_FAN, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_FAN, HORSE_SKILL_WILDATTACK, "skill_wildattack.msa")

	## HORSE_BELL
	chrmgr.SetPathName(path + "horse_bell/")
	chrmgr.RegisterMotionMode(chr.MOTION_MODE_HORSE_BELL)
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BELL, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BELL, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BELL, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
	...
	chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_BELL, HORSE_SKILL_WILDATTACK, "skill_wildattack.msa")
...
if app.ENABLE_WOLFMAN_CHARACTER:
	def __LoadGameWolfmanEx(race, path):
		...
		## GENERAL MOTION MODE
		SetNewGeneralMotions(chr.NEW_678TH_SKILL_ENABLE, path + "general/")

		chrmgr.SetMotionRandomWeight(chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT, 0, 70)
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT, "wait.msa", 30)
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_COMBO_ATTACK_1, "attack1.msa", 50)
		chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_COMBO_ATTACK_1, "attack2.msa", 50)

		chrmgr.ReserveComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, 6)
		chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_1, chr.MOTION_COMBO_ATTACK_1)
		chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_2, chr.MOTION_COMBO_ATTACK_1)
		chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_3, chr.MOTION_COMBO_ATTACK_1)
		chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_4, chr.MOTION_COMBO_ATTACK_1)
		chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_5, chr.MOTION_COMBO_ATTACK_1)
		chrmgr.RegisterComboAttackNew(chr.NEW_678TH_SKILL_ENABLE, COMBO_TYPE_1, COMBO_INDEX_6, chr.MOTION_COMBO_ATTACK_1)
		...
		for i in xrange(skill.SKILL_EFFECT_COUNT):
			...
			chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+1, "split_slash" + END_STRING + ".msa")
			chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+2, "wind_death" + END_STRING + ".msa")
			chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+3, "reef_attack" + END_STRING + ".msa")
			chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+4, "wreckage" + END_STRING + ".msa")
			chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+5, "red_possession" + END_STRING + ".msa")
			chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SKILL+(i*skill.SKILL_GRADEGAP)+6, "blue_possession" + END_STRING + ".msa")
		...
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_WAIT,				"wait.msa", 50)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_WAIT,				"wait1.msa", 30)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_WAIT,				"wait2.msa", 20)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_WALK,				"walk.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_RUN,				"run.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_DAMAGE,			"front_damage.msa", 50)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_DAMAGE,			"front_damage1.msa", 50)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_DAMAGE_BACK,		"back_damage.msa", 50)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_DAMAGE_BACK,		"back_damage1.msa", 50)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_1,	"combo_01.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_2,	"combo_02.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_3,	"combo_03.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_4,	"combo_04.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_5,	"combo_05.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_6,	"combo_06.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_CLAW, chr.MOTION_COMBO_ATTACK_7,	"combo_07.msa")
		...
		chrmgr.RegisterMotionMode(chr.MOTION_MODE_HORSE)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WAIT,				"wait.msa", 90)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WAIT,				"wait1.msa", 9)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WAIT,				"wait2.msa", 1)
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_WALK,				"walk.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_RUN,				"run.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DAMAGE,			"front_damage.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DAMAGE_BACK,		"front_damage.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, chr.MOTION_DEAD,				"dead.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, HORSE_SKILL_CHARGE,			"skill_charge.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE, HORSE_SKILL_SPLASH,			"skill_splash.msa")
		...
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_CLAW, chr.MOTION_COMBO_ATTACK_1, "combo_01.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_CLAW, chr.MOTION_COMBO_ATTACK_2, "combo_02.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_CLAW, chr.MOTION_COMBO_ATTACK_3, "combo_03.msa")
		chrmgr.Character(NewPoints, chr.MOTION_MODE_HORSE_CLAW, HORSE_SKILL_WILDATTACK, "skill_wildattack.msa")
...
def SetMovingNPC(race, name):
	...
	chrmgr.RegisterMotionMode(chr.NEW_678TH_SKILL_ENABLE)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT, "wait.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WALK, "walk.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_RUN, "run.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DEAD, "die.msa")
...
def SetGuard(race, name):
	...
	## GENERAL
	chrmgr.RegisterMotionMode(chr.NEW_678TH_SKILL_ENABLE)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SPAWN,		"00.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT,			"00.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_RUN,			"03.msa")

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DAMAGE,		"30.msa", 50)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DAMAGE,		"30_1.msa", 50)

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DAMAGE_BACK,	"34.msa", 50)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DAMAGE_BACK,	"34_1.msa", 50)

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_SUGI_PULA_DACA_VEZI,"32.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_STAND_UP,		"33.msa")

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_NU_MAI_AI_VOIE_CSF,	"35.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_STAND_UP_BACK,		"36.msa")

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DEAD,					"31.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DEAD_BACK,			"37.msa")

	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_NORMAL_ATTACK,		"20.msa")

	## Attacking Data
	chrmgr.RegisterNormalAttack(chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_NORMAL_ATTACK)
...
def SetDoor(race, name):
	...
	chrmgr.LoadRaceData(name + ".msm")
	chrmgr.RegisterMotionMode(chr.NEW_678TH_SKILL_ENABLE)
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_WAIT, "close_wait.msa")
	chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DEAD, "open.msa")
...
def SetGuildBuilding(race, name, grade):
	...
	chrmgr.RegisterMotionMode(chr.NEW_678TH_SKILL_ENABLE)
	#chrmgr.Character(NewPoints, chr.NEW_678TH_SKILL_ENABLE, chr.MOTION_DEAD, name + "_destruction.msa")
...
if app.ENABLE_DOG_MODE:
	def ReloadNPC():
		file_name = "npclist.txt"

		if systemSetting.IsDogModeStatus():
			file_name = "npclist_dogs.txt"
