	...
	(
		{
			...
			(
				...
				{ 
					...
					"children" :
					(
						{"name":"TitleName", "type":"text", "x":0, "y":0, "text":"Insotitor", "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"ExpTitle", "type":"text", "x":0, "y":0, "text": "Exp", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## EXP Gauge
				{
				...
				{ 
					...
					"children" :
					(
						{"name":"AgeTitle", "type":"text", "x":0, "y":0, "text": "Varsta", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## AGE Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"AbilitiesName", "type":"text", "x":0, "y":0, "text": "Bonusuri", "r":1.0, "g":0.0, "b":0.0, "a":1.0, "all_align" : "center"},
					),	
				},
				...
				{ 
					...
					"children" :
					(
						{"name":"DefTitle", "type":"text", "x":0, "y":0, "text": "ATAC", "color":GOLD_COLOR, "all_align" : "center"},
					),	
				},
				## Defence Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"SpTitle", "type":"text", "x":0, "y":0, "text": "MONSTRII", "color":GOLD_COLOR, "all_align" : "center"},
					),
				},
				## SP Value
				{ 
				...
				{ 
					...
					"children" :
					(
						{"name":"PetSkillTitle", "type":"text", "x":0, "y":0, "text": "Abilitati", "r":1.0, "g":0.0, "b":0.0, "a":1.0, "all_align" : "center"},
					),
				},
